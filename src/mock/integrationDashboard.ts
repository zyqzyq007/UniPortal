...
export const mockIntegrationData: IntegrationDashboardData = {
    testCaseDimensions: [
        { name: '功能', value: 120 },
        { name: '性能', value: 80 },
        { name: '边界', value: 60 },
...
export const emptyIntegrationData: IntegrationDashboardData = {
    testCaseDimensions: [],
...
export const getIntegrationDashboardData = (projectId: string, simulateTimeout = false): Promise<IntegrationDashboardData> => {
